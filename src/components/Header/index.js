...
class Header extends React.Component {
  render() {
    if(this.props.headerSize === "small") {
          ...
          <MainHeader size="small">
            <Link to="/" title="Go to homepage">
              <SiteTitle size="small">
                <strong>ZachDonsky.xyz</strong><small> is the digital portfolio of Zachary Donsky</small>
              </SiteTitle>
            </Link>
          </MainHeader>
        </Headroom>
      ...
      return (
        <MainHeader>
          <SiteTitle><strong>ZachDonsky.xyz</strong> is the digital portfolio of Zachary Donsky</SiteTitle>
          <SiteByline>
          An industrial designer with an interest in electronics and programming. <br />

          My passion project is <a href="https://chalmerscards.com" target="_blank" title="Chalmers' website" rel="noopener noreferrer">Chalmers</a>, an attempt to improve the state of homelessness in Toronto.
          </SiteByline>
        </MainHeader>
      )
    }
